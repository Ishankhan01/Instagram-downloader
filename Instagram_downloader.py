...
#Create instagram downloader with python
...
insta_reel = Reel('https://www.instagram.com/reel/CbfEOBZphUz/?utm_source=ig_web_copy_link')
...
# download function
insta_reel.download(fp=f".{int(time.time())}.mp4")
